...
import { Home, Package, PanelBottom, Sandwich, Settings, ShoppingBag, User, Users } from "lucide-react";
            ...
            <Sheet>
                ...
                <SheetContent side="left"className="sm:max-w-x">
                    <nav className="grid gap-6 text-lg font-medium">
                        ...
                        gap-2" prefetch={false}>
                            <Sandwich className="h-5 w-5 transition-all"/>
                            <span className="sr-only">Logo</span>
                        </Link>

                        <Link href="#" className="flex items-center gap-4 px-2.5 text-muted-foreground
