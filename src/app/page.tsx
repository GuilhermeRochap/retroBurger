...
import { CircleDollarSign, DollarSign, Percent, ShoppingBag, User } from 'lucide-react'
        ...
        <Card>
          <CardHeader>
            <div className='flex items-center justify-center'>
              ...
              <User className='ml-auto w-4 h-4 text-gray-800'/>
            </div>
            <CardDescription>
        ...
        <Card>
          <CardHeader>
            <div className='flex items-center justify-center'>
              ...
              <CircleDollarSign className='ml-auto w-4 h-4 text-gray-800'/>
            </div>
            <CardDescription>
          ...
          <CardContent>
            <p className='text-base sm:text-lg font-bold'>180</p>
          </CardContent>
        </Card>
      </section>
